...
BEGIN_MESSAGE_MAP(CMd3View, CView)
	...
	ON_WM_MOUSEMOVE()
	ON_COMMAND(ID_SELECT_COLOR, &CMd3View::OnSelectColor)
	ON_COMMAND(ID_SIZE_1, &CMd3View::OnSize1)
	ON_COMMAND(ID_SIZE_8, &CMd3View::OnSize8)
	ON_COMMAND(ID_SIZE_16, &CMd3View::OnSize16)
	ON_WM_CONTEXTMENU()
	ON_COMMAND(ID_SIZE_2, &CMd3View::OnSize2)
	ON_COMMAND(ID_SIZE_9, &CMd3View::OnSize9)
	ON_COMMAND(ID_SIZE_17, &CMd3View::OnSize17)
END_MESSAGE_MAP()
